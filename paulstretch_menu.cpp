...
static mainmenu_group_popup_factory g_mainmenu_group(g_paulstretch_menu_guid, mainmenu_groups::view_dsp, mainmenu_commands::sort_priority_dontcare, "Paulstretch");
...
void paulstretch_menu::startMenu()
{
	try
	{
		...
		new CWindowAutoLifetime<ImplementModelessTracking<paulstretch_dialog>>(core_api::get_main_window());
	}
