#pragma once
#ifndef PAULSTRETCHPRESET_H
#define PAULSTRETCHPRESET_H


struct paulstretchPreset
{
public:
	/**
...
private:
	...
	{
		paulstretchPreset lh(lhpreset);
		paulstretchPreset rh(rhpreset);
...
public:
	...
	paulstretchPreset(const dsp_preset& preset)
	{
		readData(preset);
	}

	paulstretchPreset(const float stretchAmount = 4.0f, const float windowSize = 0.28f, const bool enabled = false)
	{
